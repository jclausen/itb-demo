<cfscript>
	...
	//API Routing
	include "APIRoutes.cfm";	
	//login routes
	addRoute(pattern="login",handler="Authorization",action="login");
	addRoute(pattern="logout",handler="Authorization",action="logout");
	addRoute(pattern="forgot_password",handler="Authorization",action="forgot_password");
	addRoute(pattern="reset_password",handler="Authorization",action="reset_password");
	// Default Routes
