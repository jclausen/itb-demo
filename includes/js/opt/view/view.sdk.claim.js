...
define([ "Backbone", "datepicker", "theme/fuelux.wizard", "view/widgets/country.select" ], function(Backbone, datepicker, fuelux, CountrySelects) {
    ...
    var View = Backbone.View.extend({
        ...
        autoFillTemplate: '<div id="autoFillNotice" class="alert alert-info margin-bottom-30" style="display:none; margin-top: 20px">                                <p>Existing registration information was found for this serial number.  Would you like to use the registration information for this claim?</p>                                <p class="text-center">                                    <a href="javascript:void(0)" id="btnAutoFill" class="btn-flat primary">Yes</a>                                    <a href="javascript:void(0)" id="btnCancelAutoFill" class="btn-flat danger">No</a>                                </p>                                </div>',
        initialize: function() {
            var _this = this;
        ...
        onSubmitClaim: function(e) {
            ...
            $.post(_this.API_BASE_URI + "claims", postData).done(function(data) {
        ...
        onChangeInstallDate: function(e) {
            ...
            if (inputDate.getFullYear() === installDate.getFullYear() && inputDate.getDate() === installDate.getDate() && inputDate.getMonth() === installDate.getMonth()) {
        ...
        onAutoFillSelect: function(e) {
            ...
            if (typeof _this.validatedItem !== "undefined") {
                ...
                $("#autoFillNotice p.text-center").fadeOut("400", function() {
                    $("#autoFillNotice p.text-center").remove();
                });
                ...
                setTimeout(function() {
                    $("#autoFillNotice").fadeOut("400", function() {
