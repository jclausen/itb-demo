            ...
            ,onCreateUser:function(e){
                ...
                ModelRoles.fetch({
                    success:function(model,resp){
                        ...
                        $("#user-form").append(
                            "<h3>Add New User <a class='pull-right btn btn-link' id='btnCancelAddUser'><i class='icon icon-undo'></i> Cancel</a></h3>"+
                            userForm({"user":{"role":{}}})+
            ...
            ,onProcessUserAdd:function(e){
                ...
                ModelUsers.save(formData,{
                    success:function(model,resp){
                        ...
                        setTimeout(function(){
                            $("#user-creation-notice").fadeOut(300,function(){$("#user-creation-notice").remove()});
                        },1000);
