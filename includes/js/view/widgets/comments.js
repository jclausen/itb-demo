/**
* This is the Backbone View Widget for Comments
**/
define([
    'Backbone',
    'model/Comments'
        ...
        var View = Backbone.View.extend({
			...
			*/
            ...
            /**
            * Utility method to save us a callback conditional in our AJAX methods
            **/
            ...
            /**
            * Return the standardized textarea for comment edits
            **/
            ...
            /**
            * Process comment formatting (line breaks, etc.)
            **/
            ,_formatComment:function(Comment){
                Comment=Comment.replace(/(?:\r\n|\r|\n)/g, '<br>');

                //remove our last line break if submitting via Enter;
            ...
            /**
            * Returns a comment to plain text
            **/
